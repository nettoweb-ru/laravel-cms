...
return [
    ...
    "email" => "E-mail",
    "email_verify_email_message" => "Pour confirmer votre adresse email, veuillez suivre le lien",
    "email_reset_password_message" => "Pour restaurer l'accès, veuillez suivre le lien",
