...
use Netto\Models\NavigationGroup as WorkModel;
use Netto\Http\Requests\Admin\NavigationGroupRequest as WorkRequest;

class NavigationController extends BaseController
{
    use AdminActions;

    protected string $baseRoute = 'navigation';
    ...
    protected array $viewId = [
        'list' => 'cms::navigation.index',
        'edit' => 'cms::navigation.group',
    ];
