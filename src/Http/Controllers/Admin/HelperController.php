        ...
        return $this->view('cms::home', [
            'data' => [
                ...
                __('main.params_general') => [
                    ...
                    __('main.params_php_upload_max_filesize') => format_file_size(ini_parse_quantity(ini_get('upload_max_filesize'))),
                    __('main.params_php_post_max_size') => format_file_size(ini_parse_quantity(ini_get('post_max_size'))),
                    __('main.params_php_max_input_vars') => format_number(ini_get('max_input_vars')),
                ],
